...
核心機制有 2026-08-17 的實地量測支撐（並行 vs 多輪、假 green light、兩層判準的噪音率、reviewer 不重寫）。另有三項參數尚未經成對實驗驗證——**哪三項、實驗怎麼設計、目前狀態，全部記在本 skill 的開發期評測集**（刻意不從本檔連結：那是 oracle，不該進 runtime context）。
